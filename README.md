...
3. Edit https://github.com/janos1111/pyton.chatgpt_telegram_bot/blob/main/config/config.example.yml to set your tokens (OpenAI API, allowed TG y TG userbot):
